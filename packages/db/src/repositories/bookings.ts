...
export class DrizzleBookingRepository implements BookingRepository {
  ...
  async loadProjection(channexBookingId: string): Promise<BookingProjection | null> {
    ...
    return {
      ...
      paymentCollect: b.paymentCollect as BookingProjection["paymentCollect"],
      paymentType: b.paymentType as BookingProjection["paymentType"],
      otaName: b.otaName ?? "",
    ...
    if (input.projection) {
      ...
      await this.tx
        ...
        .values({
          ...
          paymentCollect: p.paymentCollect,
