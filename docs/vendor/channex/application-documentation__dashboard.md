<!-- https://docs.channex.io/application-documentation/dashboard.md -->
> For the complete documentation index, see [llms.txt](https://docs.channex.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.channex.io/application-documentation/dashboard.md).
...
<figure><img src="https://2514252617-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LWLG7_BCMgWd3mn6DYg%2Fuploads%2FCmSHvR0BzJtEZYvXxsI8%2FGroup%201%20(2).png?alt=media&amp;token=6624a6e9-50b4-4006-bc94-40407a2f1678" alt=""><figcaption><p>Booking source widget</p></figcaption></figure>
